...
- GitHub end-to-end Dev to Prod pipeline example [../github-pipeline-example](../github-pipeline-example)
...
- Deployment diff: Diff howto [diff-howto](diff-howto) and Pipeline Diff [../github-pipeline-example/tree/diff](https://github.com/nickhumanitec/humanitec-github-pipeline-example/tree/diff)
- PVC Example: [pvc](pvc)
